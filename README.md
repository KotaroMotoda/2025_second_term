...
| データレベル（DLP）  | ・SIMDプロセッサ<br/>・ベクトルプロセッサ<br/>・GPU | ・SIMD：128/256/512bit等の固定長データを一括処理。プログラマがデータ長を意識<br/>・ベクトル：可変長のデータ列を自動分割して処理。連続アクセスで効率的<br/>・GPU：数千の演算コアによる大規模並列処理.とんでもない数のコアをグループ化してそれらが新しく命令出せるので,GPUはMIMD化している. |

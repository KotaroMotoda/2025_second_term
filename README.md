...
- **SISD**: 単一命令、単一データ
- **SIMD**: 単一命令、複数データ. ベクトル(一次元配列)を操作する.ユーザからは,SISD命令実行と同じ体験であるのに,単一のプログラムカウンタが指示する単一命令に対して,全ての並列実行ユニットが同期して応答する.
- **MISD**: 複数命令、単一データ. 単一のデータ流に対して,パイプライン方式で一連の計算を実行するもの.
- **MIMD**: 複数命令、複数データ
